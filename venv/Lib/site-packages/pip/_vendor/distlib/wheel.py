...
from .util import (FileOperator, convert_path, CSVReader, CSVWriter, Cache,
                   cached_property, get_cache_base, read_exports, tempdir, get_platform)
...
class Wheel(object):
    ...
    def build(self, paths, tags=None, wheel_version=None):
        ...
        wheel_metadata = [
            ...
            'Generator: distlib %s' % __version__, 'Root-Is-Purelib: %s' % is_pure, ]
            ...
            if modified:
                ...
                if dest_dir is None:
                    fd, newpath = tempfile.mkstemp(suffix='.whl',
                                                   prefix='wheel-update-', dir=workdir)
                    os.close(fd)
                else:
