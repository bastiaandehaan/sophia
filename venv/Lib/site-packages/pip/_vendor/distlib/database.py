...
__all__ = ['Distribution', 'BaseInstalledDistribution', 'InstalledDistribution',
...
DIST_FILES = (
'INSTALLER', METADATA_FILENAME, 'RECORD', 'REQUESTED', 'RESOURCES', EXPORTS_FILENAME,
'SHARED')
...
class Distribution(object):
    ...
    def __eq__(self, other):
        ...
        if type(other) is not type(self):
            ...
            result = (
                        self.name == other.name and self.version == other.version and self.source_url == other.source_url)
        return result
                ...
                for line in f:
                    ...
                    if not os.path.exists(p):
                        ...
                        if p.endswith(('.pyc', '.pyo')):
                            continue  # otherwise fall through and fail
...
class DependencyGraph(object):
    ...
    def add_distribution(self, distribution):
        ...
        self.reverse_list[distribution] = []  # self.missing[distribution] = []
...
def make_graph(dists, scheme='default'):
    ...
    for dist in dists:
        requires = (
                    dist.run_requires | dist.meta_requires | dist.build_requires | dist.dev_requires)
        for req in requires:
            try:
