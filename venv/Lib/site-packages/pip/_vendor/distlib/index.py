...
class PackageIndex(object):
    ...
    def get_sign_command(self, filename, signer, sign_password,
        ...
        cmd.extend(['--detach-sign', '--armor', '--local-user', signer, '--output', sf,
                    filename])
    ...
    def upload_file(self, metadata, filename, signer=None, sign_password=None,
        ...
        d.update(
            {':action': 'file_upload', 'protocol_version': '1', 'filetype': filetype,
                'pyversion': pyversion, 'md5_digest': md5_digest,
