...
class EMAStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        for i, data in enumerate(self.datas):
            ...
            # EMA indicators
            fast_ema = btind.EMA(data, period=self.params.fast_ema)
            slow_ema = btind.EMA(data, period=self.params.slow_ema)

            # MACD voor betere signalen
            macd = fast_ema - slow_ema
            signal = btind.EMA(macd, period=self.params.signal_ema)
    ...
    def _is_in_session(self, data):
        ...
        return self.params.session_start <= hour < self.params.session_end
    ...
    def next(self):
        ...
        for i, data in enumerate(self.datas):
            ...
            if pos != 0 and self.params.trail_stop:
